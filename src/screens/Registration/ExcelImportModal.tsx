      ...
      {sheetStep === 'upload' ? (
        <div className="flex flex-col gap-4">
          ...
          <div className="rounded-lg border-2 border-dashed border-dust-300 bg-dust-50 p-6 text-center">
            <p className="text-xs text-rope-400 mb-3">Valores aceitos em Categoria: Aberta/Open, Amador 19/Amateur19, Light/AmadorLight, Principiante/Amador/Beginner/2D</p>
            <input
              ref={sheetInputRef}
              type="file"
              accept=".xlsx,.xls"
